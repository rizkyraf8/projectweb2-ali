...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->SetY(13);
        $this->Cell(0, 15, 'Report View Sakit Online', 0, false, 'C', 0, '', 0, false, 'M', 'M');
    }
...
$pdf->SetTitle('Report View Sakit Online');
...
<table>
    <tr>
        ...
        <th width="15%" style="text-align: center">Tanggal Sakit</th>
...
$pdf->Output('ReportSakitOnline.pdf', 'I');
